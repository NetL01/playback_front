<template>
    <form @submit.prevent="register">
        <div class="limiter">
            <div class="container-login100" style="background: #0d1533;">
                    ...
                    <form class="login100-form validate-form">
                        ...
                        <div class="for_flex">
                            ...
                            <h4 style="color: white;">
                                <span class="spanTERMS">I agree with </span
                                ><a href="#">Terms</a
                                ><span class="spanTERMS"> and </span
                                ><a href="#">Policy</a>
                            </h4>
                        </div>
...
<label class="label-checkbox100" for="ckb1">
						I agree with <a href="#">Terms</a> and <a href="#">Policy</a>
					</label>
*/
